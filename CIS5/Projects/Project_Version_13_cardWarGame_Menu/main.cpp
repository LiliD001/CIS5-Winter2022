...
//Set Random Number seed
    ...
    winner = p1Card >= nCards ? name:"Computer";                                    //Assign the winner player to the winner variable
...
void prob4(){
    cout<<setw(10)<<"END CREDITS"<<endl<<endl;
    cout<<"The game Card War was created by Liliana Darch"<<endl;
