    ...
    while (play == 'Y' || play == 'y'){                                         //Checks if the user would like to play the game
        ...
        do {
            ...
            for(int i = 0; i<games && !gmOver; i++){    
                p1 = rand()%nCards%13;                                          //Assign the random card to Player 1
                p2 = rand()%nCards%13;                                          //Assign the random card to Player 2
                ...
                if(p1 == p2) { //If we get a match, we have a war!!
                    ...
                    p1 = rand()%nCards%13;                                      //Assign a new the random card to Player 1 to play the war
                    p2 = rand()%nCards%13;                                      //Assign a new the random card to Player 2 to play the war
                    cout<<endl;


                    cout<<"***Round number "<<i<<endl;                          //Show the round number
                    if (p1 > p2){                                               // If player 1 has the highest card
